<?php
/**
 * h3qtcms1 NUX Starter Content Class
 *
 * @package  h3qtcms1
 * @since    2.0.0
 */
...
if ( ! class_exists( 'h3qtcms1_NUX_Starter_Content' ) ) :

	/**
	 * The h3qtcms1 NUX Starter Content class
	 */
	class h3qtcms1_NUX_Starter_Content {
		/**
		 * Setup class.
		 *
		 * @since 2.2.0
		...
		public function __construct() {
			...
			if ( ! isset( $_GET['sf_starter_content'] ) || 1 !== absint( $_GET['sf_starter_content'] ) ) { // WPCS: input var ok.
				add_filter( 'h3qtcms1_starter_content', '__return_empty_array' );
			}
		}

		/**
		 * Remove default widgets on activation
		 * Set an option so that this is only done the first time the user activates h3qtcms1.
		 *
		 * @since 2.2.0
		 * @return void
		 */
		public function remove_default_widgets() {
			if ( false === (bool) get_option( 'h3qtcms1_cleared_widgets' ) && true === (bool) get_option( 'h3qtcms1_nux_fresh_site' ) ) {
				update_option( 'sidebars_widgets', array( 'wp_inactive_widgets' => array() ) );
				update_option( 'h3qtcms1_cleared_widgets', true );
			}
		}
		...
		public function starter_content() {
			$starter_content = array(
				'posts'       => array(
					'about'   => array(
						'post_type'    => 'page',
						'post_title'   => __( 'About', 'h3qtcms1' ),
						'post_content' => __( 'You might be an artist who would like to introduce yourself and your work here or maybe you&rsquo;re a business with a mission to describe.', 'h3qtcms1' ),
					),
					'contact' => array(
						'post_type'    => 'page',
						'post_title'   => __( 'Contact', 'h3qtcms1' ),
						'post_content' => __( 'This is a page with some basic contact information, such as an address and phone number. You might also try a plugin to add a contact form.', 'h3qtcms1' ),
					),
					'blog',
				),
				'attachments' => array(
				...
				'nav_menus'   => array(
					...
					'secondary' => array(
						'name'  => __( 'Secondary Menu', 'h3qtcms1' ),
						'items' => array(
							'my_account' => array(
								'type'      => 'post_type',
								'object'    => 'page',
					...
					'handheld'  => array(
						'name'  => __( 'Handheld Menu', 'h3qtcms1' ),
						'items' => array(
							'shop' => array(
								'type'      => 'post_type',
								'object'    => 'page',
			...
			if ( version_compare( get_bloginfo( 'version' ), '5.2', '>=' ) &&
			   ( defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '3.6.0', '>=' ) ) ) {
				$homepage_content = array(
					'post_title' => esc_attr__( 'Homepage', 'h3qtcms1' ),
					'template'   => 'template-fullwidth.php',
				);
			} else {
				$homepage_content = array(
					'post_title'   => esc_attr__( 'Welcome', 'h3qtcms1' ),
					/* translators: %s: 'End Of Line' symbol */
					'post_content' => sprintf( esc_attr__( 'This is your homepage which is what most visitors will see when they first visit your shop.%sYou can change this text by editing the "Welcome" page via the "Pages" menu in your dashboard.', 'h3qtcms1' ), PHP_EOL . PHP_EOL ),
			...
			$woocommerce_pages        = h3qtcms1_NUX_Admin::get_woocommerce_pages();
			...
			add_theme_support( 'starter-content', apply_filters( 'h3qtcms1_starter_content', $starter_content ) );
		}
		...
		public function filter_start_content( $content, $config ) {
			...
			if ( true !== (bool) get_option( 'h3qtcms1_nux_fresh_site' ) ) {
				unset( $content['posts']['about'] );
				unset( $content['posts']['contact'] );
				unset( $content['nav_menus'] );
				unset( $content['widgets'] );
		...
		public function add_product_tax() {
			...
			add_filter( 'h3qtcms1_product_categories_shortcode_args', array( $this, 'filter_sf_categories' ) );
		}
		...
		/**
		 * Filter h3qtcms1 Product Categories shortcode.
		 *
		 * @since 2.2.0
		...
		private function _starter_content_products() {
			$accessories_name        = esc_attr__( 'Accessories', 'h3qtcms1' );
			$accessories_description = esc_attr__( 'A short category description', 'h3qtcms1' );

			$hoodies_name        = esc_attr__( 'Hoodies', 'h3qtcms1' );
			$hoodies_description = esc_attr__( 'A short category description', 'h3qtcms1' );

			$tshirts_name        = esc_attr__( 'Tshirts', 'h3qtcms1' );
			$tshirts_description = esc_attr__( 'A short category description', 'h3qtcms1' );

			$products = array(
				// Accessories.
				'beanie'             => array(
					'post_title'     => esc_attr__( 'Beanie', 'h3qtcms1' ),
				...
				'belt'               => array(
					'post_title'     => esc_attr__( 'Belt', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'cap'                => array(
					'post_title'     => esc_attr__( 'Cap', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
					'thumbnail'      => '{{cap-image}}',
				...
				'sunglasses'         => array(
					'post_title'     => esc_attr__( 'Sunglasses', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-logo'   => array(
					'post_title'     => esc_attr__( 'Hoodie with Logo', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-pocket' => array(
					'post_title'     => esc_attr__( 'Hoodie with Pocket', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-zipper' => array(
					'post_title'     => esc_attr__( 'Hoodie with Zipper', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie'             => array(
					'post_title'     => esc_attr__( 'Hoodie', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'long-sleeve-tee'    => array(
					'post_title'     => esc_attr__( 'Long Sleeve Tee', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'polo'               => array(
					'post_title'     => esc_attr__( 'Polo', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'tshirt'             => array(
					'post_title'     => esc_attr__( 'Tshirt', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'vneck-tee'          => array(
					'post_title'     => esc_attr__( 'Vneck Tshirt', 'h3qtcms1' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
			...
			return apply_filters( 'h3qtcms1_starter_content_products', $products );
		}
		...
		private function _homepage_blocks_content() {
			$content = '
				...
				<h2 style="text-align:center">' . __( 'Shop by Category', 'h3qtcms1' ) . '</h2>
				<!-- /wp:heading -->
				...
				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'New In', 'h3qtcms1' ) . '</h2>
				<!-- /wp:heading -->
				...
				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'Fan Favorites', 'h3qtcms1' ) . '</h2>
				<!-- /wp:heading -->
				...
				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'On Sale', 'h3qtcms1' ) . '</h2>
				<!-- /wp:heading -->
				...
				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'Best Sellers', 'h3qtcms1' ) . '</h2>
				<!-- /wp:heading -->
		...
		private function _replace_homepage_blocks_symbols() {
			...
			if ( ! empty( $hero ) ) {
				$cover = '
					...
					<h1 style="text-align:center">' . __( 'Welcome', 'h3qtcms1' ) . '</h1>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"align":"center","customTextColor":"#000000"} -->
					<p style="color:#000000;text-align:center" class="has-text-color">' . __( 'This is your homepage which is what most visitors will see when they first visit your shop.', 'h3qtcms1' ) . '</p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"align":"center","customTextColor":"#000000"} -->
					<p style="color:#000000;text-align:center" class="has-text-color">' . __( 'You can change this text by editing the "Welcome" page via the "Pages" menu in your dashboard.', 'h3qtcms1' ) . '</p>
			...
			if ( ! empty( $products ) ) {
				$handpicked = '
					<!-- wp:heading {"align":"center"} -->
					<h2 style="text-align:center">' . __( 'We Recommend', 'h3qtcms1' ) . '</h2>
					<!-- /wp:heading -->
		...
		private function _validate_tasks( $tasks ) {
			$valid_tasks = apply_filters( 'h3qtcms1_valid_tour_tasks', array( 'homepage', 'products' ) );
...
return new h3qtcms1_NUX_Starter_Content();
