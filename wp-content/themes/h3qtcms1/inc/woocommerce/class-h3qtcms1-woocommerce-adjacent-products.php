<?php
/**
 * h3qtcms1 WooCommerce Adjacent Products Class
 *
 * @package  h3qtcms1
 * @since    2.4.3
 */
...
if ( ! class_exists( 'h3qtcms1_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The h3qtcms1 WooCommerce Adjacent Products Class
	 */
	class h3qtcms1_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'h3qtcms1_woocommerce_adjacent_query_args', $args ) );
